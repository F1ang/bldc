 ...
 *
 * Source file:
 * /home/benjamin/Skrivbord/tmp/uavcan/libcanard/dsdl_compiler/pyuavcan/uavcan/dsdl_files/uavcan/equipment/power/1090.PrimaryPowerSupplyStatus.uavcan
 */
 ...
 */
uint32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_encode_internal(uavcan_equipment_power_PrimaryPowerSupplyStatus *source, void *msg_buf,
 ...
 */
int32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
