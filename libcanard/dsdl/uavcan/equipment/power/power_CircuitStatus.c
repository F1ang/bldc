 ...
 *
 * Source file:
 * /home/benjamin/Skrivbord/tmp/uavcan/libcanard/dsdl_compiler/pyuavcan/uavcan/dsdl_files/uavcan/equipment/power/1091.CircuitStatus.uavcan
 */
 ...
 */
uint32_t uavcan_equipment_power_CircuitStatus_encode_internal(uavcan_equipment_power_CircuitStatus *source, void *msg_buf, uint32_t offset,
 ...
 */
int32_t uavcan_equipment_power_CircuitStatus_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                             uavcan_equipment_power_CircuitStatus *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_equipment_power_CircuitStatus_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
                                                    uavcan_equipment_power_CircuitStatus *dest, uint8_t **dyn_arr_buf)
{
