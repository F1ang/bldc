...
// 获取节点信息（请求/响应），含名称、软件/硬件版本、唯一 ID
...
uint32_t uavcan_protocol_GetNodeInfoRequest_encode_internal(uavcan_protocol_GetNodeInfoRequest *CANARD_MAYBE_UNUSED(source),
                                                            void *CANARD_MAYBE_UNUSED(msg_buf), uint32_t offset,
                                                            uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    return offset;
}

uint32_t uavcan_protocol_GetNodeInfoRequest_encode(uavcan_protocol_GetNodeInfoRequest *CANARD_MAYBE_UNUSED(source),
...
int32_t uavcan_protocol_GetNodeInfoRequest_decode(const CanardRxTransfer *CANARD_MAYBE_UNUSED(transfer), uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                  uavcan_protocol_GetNodeInfoRequest *CANARD_MAYBE_UNUSED(dest),
 ...
 */
uint32_t uavcan_protocol_GetNodeInfoResponse_encode_internal(uavcan_protocol_GetNodeInfoResponse *source, void *msg_buf, uint32_t offset,
                                                             uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    uint32_t c = 0;
 ...
 */
int32_t uavcan_protocol_GetNodeInfoResponse_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                            uavcan_protocol_GetNodeInfoResponse *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                            int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_GetNodeInfoResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_GetNodeInfoResponse *dest,
                                                   uint8_t **dyn_arr_buf)
{
