 ...
 */
uint32_t uavcan_protocol_param_GetSetRequest_encode_internal(uavcan_protocol_param_GetSetRequest *source, void *msg_buf, uint32_t offset,
                                                             uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    uint32_t c = 0;

    source->index = CANARD_INTERNAL_SATURATE_UNSIGNED(source->index, 8191) canardEncodeScalar(msg_buf, offset, 13, (void *)&source->index); // 8191
    offset += 13;
 ...
 */
int32_t uavcan_protocol_param_GetSetRequest_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                            uavcan_protocol_param_GetSetRequest *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                            int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
    ...
    if (payload_len) {
        ...
        // - Array length 7 bits
        ret = canardDecodeScalar(transfer, (uint32_t)offset, 7, false,
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_GetSetRequest_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_param_GetSetRequest *dest,
                                                   uint8_t **dyn_arr_buf)
{
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_param_GetSetResponse_encode_internal(uavcan_protocol_param_GetSetResponse *source, void *msg_buf, uint32_t offset,
                                                              uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    uint32_t c = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_GetSetResponse_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                             uavcan_protocol_param_GetSetResponse *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                             int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_GetSetResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
                                                    uavcan_protocol_param_GetSetResponse *dest, uint8_t **dyn_arr_buf)
{
    const int32_t offset = 0;
    int32_t ret = 0;
