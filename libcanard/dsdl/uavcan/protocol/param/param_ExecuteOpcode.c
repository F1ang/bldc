 ...
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeRequest_encode_internal(uavcan_protocol_param_ExecuteOpcodeRequest *source, void *msg_buf,
 ...
 */
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeResponse_encode_internal(uavcan_protocol_param_ExecuteOpcodeResponse *source, void *msg_buf,
                                                                     uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    source->argument = CANARD_INTERNAL_SATURATE(source->argument, 140737488355327)
        canardEncodeScalar(msg_buf, offset, 48, (void *)&source->argument); // 140737488355327
    ...
    source->ok = CANARD_INTERNAL_SATURATE_UNSIGNED(source->ok, 1) canardEncodeScalar(msg_buf, offset, 1, (void *)&source->ok); // 1
    offset += 1;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
