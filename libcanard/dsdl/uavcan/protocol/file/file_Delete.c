 ...
 */
uint32_t uavcan_protocol_file_DeleteRequest_encode_internal(uavcan_protocol_file_DeleteRequest *source, void *msg_buf, uint32_t offset,
 ...
 */
int32_t uavcan_protocol_file_DeleteRequest_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                           uavcan_protocol_file_DeleteRequest *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                           int32_t offset)
{
    int32_t ret = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_DeleteRequest_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_file_DeleteRequest *dest,
                                                  uint8_t **dyn_arr_buf)
{
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_DeleteResponse_encode_internal(uavcan_protocol_file_DeleteResponse *source, void *msg_buf, uint32_t offset,
                                                             uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    // Compound
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_DeleteResponse_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                            uavcan_protocol_file_DeleteResponse *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                            int32_t offset)
{
    int32_t ret = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_DeleteResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_file_DeleteResponse *dest,
                                                   uint8_t **dyn_arr_buf)
{
    const int32_t offset = 0;
    int32_t ret = 0;
