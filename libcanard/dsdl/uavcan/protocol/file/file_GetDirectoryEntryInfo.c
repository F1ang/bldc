 ...
 */
uint32_t uavcan_protocol_file_GetDirectoryEntryInfoRequest_encode_internal(uavcan_protocol_file_GetDirectoryEntryInfoRequest *source, void *msg_buf,
 ...
 */
int32_t uavcan_protocol_file_GetDirectoryEntryInfoRequest_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_GetDirectoryEntryInfoRequest_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_GetDirectoryEntryInfoResponse_encode_internal(uavcan_protocol_file_GetDirectoryEntryInfoResponse *source, void *msg_buf,
                                                                            uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    // Compound
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_GetDirectoryEntryInfoResponse_decode_internal(const CanardRxTransfer *transfer,
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_GetDirectoryEntryInfoResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len,
