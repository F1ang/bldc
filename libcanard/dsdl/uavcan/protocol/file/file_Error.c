 ...
 */
uint32_t uavcan_protocol_file_Error_encode_internal(uavcan_protocol_file_Error *source, void *msg_buf, uint32_t offset,
 ...
 */
int32_t uavcan_protocol_file_Error_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                   uavcan_protocol_file_Error *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_Error_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_file_Error *dest,
                                          uint8_t **dyn_arr_buf)
{
