 ...
 */
uint32_t uavcan_protocol_file_WriteRequest_encode_internal(uavcan_protocol_file_WriteRequest *source, void *msg_buf, uint32_t offset,
 ...
 */
int32_t uavcan_protocol_file_WriteRequest_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                          uavcan_protocol_file_WriteRequest *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                          int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_WriteRequest_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_file_WriteRequest *dest,
                                                 uint8_t **dyn_arr_buf)
{
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_WriteResponse_encode_internal(uavcan_protocol_file_WriteResponse *source, void *msg_buf, uint32_t offset,
                                                            uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    // Compound
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_WriteResponse_decode_internal(const CanardRxTransfer *transfer, uint16_t CANARD_MAYBE_UNUSED(payload_len),
                                                           uavcan_protocol_file_WriteResponse *dest, uint8_t **CANARD_MAYBE_UNUSED(dyn_arr_buf),
                                                           int32_t offset)
{
    int32_t ret = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_WriteResponse_decode(const CanardRxTransfer *transfer, uint16_t payload_len, uavcan_protocol_file_WriteResponse *dest,
                                                  uint8_t **dyn_arr_buf)
{
    const int32_t offset = 0;
    int32_t ret = 0;
